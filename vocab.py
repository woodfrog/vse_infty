...
import os
import json
from lib.utils.hdfs_utils import hopen
...
if __name__ == '__main__':
    ...
    # Generate dictionary file for conceptual caption
    vocab = build_vocab_conceptual(base_dir='../../DownloadConceptualCaptions/', threshold=4)
    out_path = './vocab/conceptual_cloze_vocab.json'
    serialize_vocab(vocab, out_path)
    print('Saved vocabulary file to {}'.format(out_path))
